...
//using excel to read data and then testing on website

public class DataWithTest {
//see excel data doc with this
    //this is without the row numbers
    //declare variable
    ...
    public static String[][] getTestData(String tableName) {//main method , this will grab all the data
